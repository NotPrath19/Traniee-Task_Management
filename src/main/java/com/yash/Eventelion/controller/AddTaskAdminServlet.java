 ...
 */
@WebServlet("/AddTaskAdminServlet")
public class AddTaskAdminServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Task task = new Task();
		task.setUserName(request.getParameter("SelectUser"));
	    ...
	    String RedirectVal = "AddedTaskAdmin";
