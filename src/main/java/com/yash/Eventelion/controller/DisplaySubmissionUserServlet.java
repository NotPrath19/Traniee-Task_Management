 ...
 */
@WebServlet("/DisplaySubmissionUserServlet")
public class DisplaySubmissionUserServlet extends HttpServlet {
     ...
     */
    public DisplaySubmissionUserServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Submission> taskList =  submissionService.getSubmissionListUser(request.getParameter("User"));
