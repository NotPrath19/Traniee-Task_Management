 ...
 */
@WebServlet("/GetUserListForAdminUpdateServlet")
public class GetUserListForAdminUpdateServlet extends HttpServlet {
     ...
     */
    public GetUserListForAdminUpdateServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String RedirectVal = "GetUserListForAdminUpdate";
		request.setAttribute("Valid",RedirectVal);
		request.setAttribute("userList",userList);
	    request.setAttribute("User",request.getParameter("User"));	
		request.setAttribute("Desig",request.getParameter("Desig"));
		request.setAttribute("NavInput", request.getParameter("NavInput"));
		request.setAttribute("UserName",request.getParameter("UserName"));	
		request.setAttribute("Id",request.getParameter("Id"));
		request.setAttribute("Date",request.getParameter("Date"));
		request.setAttribute("Tasks",request.getParameter("Tasks"));
