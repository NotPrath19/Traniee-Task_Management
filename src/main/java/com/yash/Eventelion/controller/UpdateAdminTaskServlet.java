 ...
 */
@WebServlet("/UpdateAdminTaskServlet")
public class UpdateAdminTaskServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		taskService.updateUserName(Integer.parseInt(request.getParameter("Id")), request.getParameter("SelectUser"));
	    ...
	    String RedirectVal = "UpdatedTasksAdmin";
